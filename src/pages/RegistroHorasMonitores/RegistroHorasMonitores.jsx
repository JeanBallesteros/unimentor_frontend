    ...
    const handleButtonAceptar = async (index) => {
      ...
      if (response.status === 200) {
        Swal.fire({
          ...
          text: `El registro de horas de ${hoursLogProfessor[index].monitor[0].fullname} en ${hoursLogProfessor[index].date.slice(0, 10)} ha sido aceptado.`,
          icon: "success",
          confirmButtonText: "OK",
        })
        .then(() => {
    ...
    const handleButtonDenegar = async (index) => {
      ...
      if (response.status === 200) {
        Swal.fire({
          ...
          text: `El registro de horas de ${hoursLogProfessor[index].monitor[0].fullname} en ${hoursLogProfessor[index].date.slice(0, 10)} ha sido neutralizado.`,
          icon: "success",
          confirmButtonText: "OK",
        })
        .then(() => {
